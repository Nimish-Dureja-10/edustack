...
const CourseModal = ({isOpen,onClose,id,deleteButtonHandler,courseTitle,lectures=[1,2,3,4,5,6],addLectureHandler}) => {
            ...
            <Box px={['0','16']}>
              ...
              <Heading children='Lectures' size={'lg'} />
              {
                lectures.map((item,index)=>(
                  <VideoCard key={index} title={"React Into"} description={"This is a into lecture where you will learn about the basics of react"} num={index+1} lectureId={"dhkuwqy84lectureId"} courseId={id} deleteButtonHandler={deleteButtonHandler} />
                ))
              }
            </Box>
            <Box>
