  ...
  return (
    <Grid css={{cursor:`url(${cursor}), default`}} minH={'100vh'} templateColumns={['1fr','5fr 1fr']}>
        <Box boxSizing='border-box' py='16' px={['4','0']}>
            <Text children={`Last Change was on ${String(new Date()).split('G')[0]}`} textAlign={'center'} opacity='0.5' />
            ...
            <Stack direction={['column','row']} minH='24' justifyContent={'space-evenly'}>
                ...
                <Databox title="Users" qty={29} qtyPercentage={'70'} profit={true} />
                <Databox title="Subscription" qty={60} qtyPercentage={'20'} profit={false} />
            </Stack>
            <Box m={['0','16']} borderRadius='lg' p={['0','16']} mt={['4','16']} boxShadow={'-2px 0 10px rgba(107,70,193,0.5)'} >
                <Heading textAlign={['center','left']} size='md' children='Views Graph' pt={['8','0']} ml={['0.5','16']} />
                <LineChart />
            </Box>
            <Grid templateColumns={['1fr', '2fr 1fr']}>
                <Box p='4'>
                    ...
                    <Box>
                        ...
                        <Bar profit={false} title={"Susbcription"} value={20} />
                    </Box>
                </Box>
